...
if(isset($_POST['submit']))
{
	...
	if($password==$repassword)
	{
		...
		$insert=$db->query("INSERT INTO user1(fname,lname,email,username,phone,department,designation,password,vkey) 
	VALUES('$fname','$lname','$email','$username','$phone','$department','$designation','$password','$vkey')")
	...
	if($insert)
	{
		...
		$message="<a href='http://localhost/newone/verify.php?vkey=$vkey'>Verify my Email</a>";
		$headers="From: nprojectpdavm@gmail.com \r\n";
	...
	$_SESSION['message']="A Verification Email is sent to your Email. Please Verify";
